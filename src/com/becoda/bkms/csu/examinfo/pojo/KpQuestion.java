package com.becoda.bkms.csu.examinfo.pojo;
...
public class KpQuestion implements java.io.Serializable {
	...
	/** minimal constructor */
	public KpQuestion(String questionId) {
		this.questionId = questionId;
	}

	/** full constructor */
	public KpQuestion(String questionId, String questionNum,
			String questionType, String questionClassify,
			String questionContent, String answer, String hardLevel,
			String lessonNum, String lessonName, String createUserId,
			String createUserName, Date createTime, String updateUserId,
			String updateUserName, Date updateTime, String status2,
			String attr1, String attr2, String attr3, String isdel) {
		this.questionId = questionId;
