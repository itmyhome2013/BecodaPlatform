...
public class KpClassSpace implements java.io.Serializable {
	...
	/** full constructor */
	public KpClassSpace(String classId, String title, String pictureName,
			String pictureUrl, String vedioName, String vedioUrl,
			String suggest, String status, String handleUser,
			String createUser, Date createTime, String isCurveWrecker) {
