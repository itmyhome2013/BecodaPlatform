...
import com.becoda.bkms.east.jhzb.ucc.IInfoItemUCC;
    ...
    public void createInfoItem(InfoItemBO infoItem, String userId) throws BkmsException {
        try {
            ...
            if (len == null || len.equals(""))
                len = "100";
//            wageAPI.createOrDelWageInfoItem(infoItem.getSetId(), infoItem.getItemId(), len, "add");
...
//        }
	...
	@Override
	public void addOrUpdateInfo(String setId,String infoId, String field, String values)
