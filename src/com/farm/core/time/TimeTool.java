...
public class TimeTool {
	...
	public static List<String> getDays(String startTime, String endTime) {
		...
		try {
			...
			tempStart.add(Calendar.DATE, -1);// 日期减1(包含开始)
	...
	public static void main(String[] args) {
		//System.out.println(TimeTool.getFormatTimeDate12("19980415231111dd","yyyy年MMddHHmm分ss秒"));
		System.out.println(getDays("2018-07-01","2018-07-03"));
	}
}
