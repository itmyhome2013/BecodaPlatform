	...
	$.parser = {
		...
		parse : function(_2) {
			...
			$(".easyui-validatebox").each(function(){
				if($(this).attr("data-options").indexOf("required:true")>-1&&$(this).attr("data-options").indexOf("isAddStar:false")==-1){
					$(this).after("<span style='color:red;font-size:15px;'> *</span>");
				}
			})
			var aa = [];
